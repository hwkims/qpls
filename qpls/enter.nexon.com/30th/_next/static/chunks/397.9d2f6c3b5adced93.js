        ...
        3397: function(e, a, t) {
            ...
            var O = function(e) {
                    let {
                        ...
                        isMobile: p
                    } = (0, S.dD)(), w = (0, c.useRef)(null), g = (0, c.useRef)(null), h = (0, c.useRef)(null), b = (0, c.useRef)(null), f = (0, c.useRef)(null), {
                        ref: y,
                        isClicked: O,
                        setIsClicked: D
                    } = (0, S.A8)(), {
                    ...
                    function E(e) {
                        Object.keys(e).forEach(a => {
                            let t = e[a];
                            t.fileUrl ? (["bg", "bgDesk", "bgDeco"].includes(a) && (t.depth = N.yg[a].depth), h.current.game.events.emit("change-asset", {
                                key: null != a ? a : t.type,
                                id: t.fileUrl,
                                url: (0, k.xn)(N.Wl, t.fileUrl),
                                depth: t.depth
                            })) : "bg" === a ? (h.current.game.events.emit("remove-asset", {
                                key: a
                            }), h.current.game.events.emit("remove-asset", {
                                key: "bgDeco"
                            }), h.current.game.events.emit("remove-asset", {
                                key: "bgDesk"
                            })) : h.current.game.events.emit("remove-asset", {
                    ...
                    async function K(e) {
                        ...
                        h.current && (h.current.game.events.on("load", () => {
                            E(r.avatar.tempSavedAvatar)
                        }), h.current.game.events.emit("is-ready"))
                    }, []), (0, c.useEffect)(() => {
                        g.current && (g.current.scrollTop = 0), w.current && (w.current.scrollTop = 0)
                    }, [o]), (0, c.useEffect)(() => {
                        K(["avatar"])
                    }, []);
                    let L = o[o.length - 1],
                                                    ...
                                                    children: (0, n.jsx)(d.Z, {
                                                        ...
                                                        children: (0, n.jsx)("button", {
                                                            ...
                                                            onClick: function() {
                                                                ...
                                                                }), h.current.game.events.emit("remove-asset-all-except-avatar");
                                                ...
                                                children: [(0, n.jsx)(M.default, {
                                                    ...
                                                    children: (0, n.jsx)(d.Z, {
                                                        ...
                                                        children: (0, n.jsx)("button", {
                                                            ...
                                                            onClick: () => {
                                                                let e;
                                                                return r.avatar.undo.push(JSON.parse(JSON.stringify(r.avatar.tempSavedAvatar))), r.avatar.redo = [], e = JSON.parse(JSON.stringify(r.avatar.tempSavedAvatar)), void("bg" === s ? (h.current.game.events.emit("remove-asset", {
                                                                    key: s
                                                                }), h.current.game.events.emit("remove-asset", {
                                                                    key: "bgDeco"
                                                                }), h.current.game.events.emit("remove-asset", {
            ...
            var E = function(e) {
                    ...
                    let {
                        ...
                        userProfile: p,
                        setContainerRef: w
                    } = e, g = (0, c.useContext)(Q), {
                        a2sObjectName: h
                    } = g, b = (0, c.useRef)(null), f = (0, c.useRef)(null), {
                        randomContestItems: y
                    } = (0, S.OM)();
                    async function j() {
                        (0, v.k)("event", "avatar_이미지저장"), (0, d.D)(h, {
                            name: "Download",
                            pagecode: "65478"
                        });
                        let e = f.current;
                    ...
                    return (0, c.useEffect)(() => {
                        b.current.game.events.on("load", () => {
                            ! function() {
                                let e = g.avatar.tempSavedAvatar;
                                Object.keys(e).forEach(a => {
                                    let t = e[a];
                    ...
                    }, [g.avatar.tempSavedAvatar]), (0, n.jsxs)("div", {
                        ref: w,
                                    ...
                                    children: (0, n.jsx)("button", {
                                        ...
                                        onClick: async () => {
                                            ...
                                            if (!(null === (t = window.inface) || void 0 === t ? void 0 : null === (a = t.auth) || void 0 === a ? void 0 : null === (e = a.isSignedIn) || void 0 === e ? void 0 : e.call(a))) {
                                                let e = JSON.stringify(g.avatar.tempSavedAvatar);
            ...
            function B(e) {
                let {
                    ...
                    resizeDependency: i
                }), [v, m] = (0, c.useState)(null), [_, p] = (0, c.useState)(!1), [w, g] = (0, c.useState)({
                    baseData: {
                        gender: ""
                    },
                    tempSavedAvatar: {},
