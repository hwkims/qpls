        ...
        6998: function(e, t, n) {
            ...
            function L(e) {
                ...
                let {
                    ...
                    userProfile: p
                } = d, [h, v] = (0, x.useState)(i), [b, C] = (0, x.useState)(""), [L, Z] = (0, x.useState)([]), [H, V] = (0, x.useState)({
                    commentId: null,
                    content: ""
                }), [P, I] = (0, x.useState)(1), F = !!d.userProfile, {
                    data: T,
                    mutate: O
                } = (0, f.ZP)(() => "/content", () => {
                ...
                if ((0, x.useEffect)(() => {
                        ...
                        Z(e)
                    }, [null == B ? void 0 : B.data]), !(null == T ? void 0 : T.data) || !(null == B ? void 0 : B.data)) return;
                let U = T.data,
                    {
                        pageInfo: G
                    } = B.data,
                    ...
                    J = async () => {
                        if (!F) return await w.lp.openMessage({
                            ...
                            children: [(0, a.jsx)(_, {
                                ...
                                children: [(0, a.jsxs)("div", {
                                    ...
                                    children: [(0, a.jsxs)("div", {
                                        ...
                                        isSignedIn: F,
                                        placeholder: F ? "부적절한 댓글은 삭제될 수 있습니다." : "로그인 후 댓글을 작성할 수 있습니다.",
                                        onClick: () => {
                                            if (!F) return window.inface.auth.gotoSignIn()
                                        },
                                        onChange: C,
                                        value: b,
                                        onSubmit: et
        ...
        5145: function(e, t, n) {
            ...
            function R(e) {
                ...
                return (0, a.jsx)(b, { ...e,
                    ...
                    footers: [(0, a.jsx)(D.Z, {
                        ...
                        children: (0, a.jsx)(M, {
                            onClick: () => {
                                console.log("??"), (0, E.k)("event", "avatar_로그인없이아바타만들기"), t(!0)
                            }
                        })
            ...
            function Z() {
                ...
                let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    r = i.length <= 0 ? null !== (e = L[o]) && void 0 !== e ? e : L.error : i;
                return (0, a.jsx)(b, { ...t,
