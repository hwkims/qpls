    ...
    [22], {
        ...
        5022: function(e, n, a) {
            ...
            var U = function(e) {
                ...
                (0, i.useEffect)(() => {
                    ...
                    setTimeout(() => {
                        _.current && _.current.classList.add(w("anim-start"))
                    }, 1500)
                }, []), (0, i.useEffect)(() => {
                    ...
                    l.current.src = e < 1280 ? "/30th/common/MO_30TH_BACK.mp4" : "/30th/common/PC_30TH_BACK.mp4", l.current.addEventListener("canplay", () => {
                        var e;
                        null === (e = l.current) || void 0 === e || e.classList.add(w("video-fadein"))
                    })
                }, [P]);
                let O = (a = null == y ? void 0 : null === (n = y.local_profile_props) || void 0 === n ? void 0 : n.nexon_name) ? (0, t.jsxs)(t.Fragment, {
                    children: [(0, t.jsxs)("span", {
                        className: w("nexon-name"),
                        children: ["[", a, "]"]
                    }), "님의"]
                }) : "당신의";
                return P ? (0, t.jsxs)("div", {
                    className: w("event-section"),
                    children: [f && (0, t.jsx)(N, {
                        ...
                        className: w("event-section-header"),
                        children: (0, t.jsxs)("div", {
                            className: w("main-header-section"),
                            children: [(0, t.jsx)("div", {
                                className: w("main-header-icon"),
                                "aria-description": "헤더 아이콘"
                            }), (0, t.jsxs)("div", {
                                className: w("main-header-banners"),
                                children: [(0, t.jsx)(d.Z, {
                                    ...
                                    children: (0, t.jsx)("a", {
                                        ...
                                        target: "_blank",
                                        className: w("main-header-banner-hyundaicard")
                                    })
                                }), (0, t.jsx)(d.Z, {
                                    "data-a2s-web-obj": "Main",
                                    ...
                                    children: (0, t.jsx)("a", {
                                        ...
                                        target: "_blank",
                                        className: w("main-header-banner-nexonplay")
                                    })
                                })]
                            }), (0, t.jsxs)("div", {
                                className: w("main-catchphrase"),
                                children: [(0, t.jsx)("div", {
                                    className: w("main-game-card-wrapper"),
                                    children: (0, t.jsx)(C, {
                                        delay: 1e3
                                    })
                                }), (0, t.jsx)("p", {
                                    className: w("call-nexon-user-name"),
                                    children: O
                                }), (0, t.jsx)("div", {
                                    ref: _,
                                    className: w("main-catchphrase-point-image"),
                                    "aria-description": "즐거움이 이어지도록"
                                }), (0, t.jsxs)("div", {
                                    className: w("main-catchphrase-body"),
                                    children: [(0, t.jsx)("p", {
                                        className: w("main-catchphrase-title"),
                                        children: "1년 내내 계속되는 즐거움!"
                                    }), (0, t.jsx)("p", {
                                        className: w("main-catchphrase-description"),
                                        children: "넥슨 30주년을 기념하며 쉼없는 이벤트가 이어집니다."
                                    }), (0, t.jsxs)("p", {
                                        className: w("main-catchphrase-description"),
                                        children: [(0, t.jsx)("span", {
                                            className: w("mobile-block"),
                                    ...
                                    className: w("main-header-event-period"),
                        ...
                        children: [(0, t.jsxs)("ul", {
                            className: w("event-gnb-list"),
                            children: [(0, t.jsx)("li", {
                                className: w("event-gnb-list-item"),
                                children: (0, t.jsx)(d.Z, {
                                    "data-a2s-web-obj": "Main",
                                    ...
                                    children: (0, t.jsx)(r.default, {
                                        ...
                                        onClick: () => x(0),
                                        children: (0, t.jsx)("span", {
                                            className: w("gnb-tab-relayevent", 0 === b && "on"),
                                ...
                                children: (0, t.jsx)(d.Z, {
                                    "data-a2s-web-obj": "Main",
                                    "data-a2s-option-name": "CashTab",
                                    "data-a2s-option-pagecode": "65478",
                                    children: (0, t.jsx)(r.default, {
                                        href: I[1],
                                        onClick: () => x(1),
                                        children: (0, t.jsx)("span", {
                                            className: w("gnb-tab-cash", 1 === b && "on"),
                                            "aria-description": "넥슨 총 30억 캐시 이벤트"
                                        })
                                    })
                                })
                            }), (0, t.jsx)("li", {
                                ...
                                children: (0, t.jsx)(r.default, {
                                    ...
                                    onClick: () => x(2),
                                    children: (0, t.jsx)("span", {
                                        className: w("gnb-tab-avatar", 2 === b && "on"),
                                        "aria-description": "추억의 아바타 만들기 이벤트"
                                    })
                                })
                            })]
                        }), (0, t.jsx)("section", {
                            className: w("event-body"),
                            children: (0, t.jsx)(E.Provider, {
                                value: R,
                                children: c
                            })
                        })]
                    }), (0, t.jsx)("section", {
                        className: w("event-footer"),
                        children: (0, t.jsx)("div", {
                            className: w("event-footer-container"),
                            children: (0, t.jsxs)("div", {
                                className: w("copyright-container"),
                                children: [(0, t.jsx)("div", {
                                    className: w("nexon-logo")
                                }), (0, t.jsx)("p", {
        ...
        3569: function(e, n, a) {
            ...
            let t = [{
                ...
                period: "1차 이벤트 진행 중! 7/25(목) 2차 공개 예정!",
                ...
                gtagName: "FC 모바일",
                description: "조세 무리뉴 감독과 함께!\n출석하고 [30주년] 토큰을 차근차근 모으세요!\n7/18(목) Special One한 클래스가 찾아옵니다!",
