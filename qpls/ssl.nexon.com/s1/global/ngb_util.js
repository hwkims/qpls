...
function __NgbBrowser() {
    ...
    this.check = function(browserName) {
        return this.agt.indexOf(browserName) != -1
    };
    this.msie = function() {
        return this.check("msie") || this.check("trident")
    };
    this.msie5 = function() {
        return this.check("msie 5")
    };
    this.msie55 = function() {
        return this.check("msie 5.5")
    };
    this.msie6 = function() {
        return this.check("msie 6")
    };
    this.msie7 = function() {
        return this.check("msie 7")
    };
    this.msie8 = function() {
        return this.check("msie 8")
    };
    this.msie9 = function() {
        return this.check("msie 9")
    };
    this.msie10 = function() {
        return this.check("msie 10")
    };
    this.chrome = function() {
        return this.check("chrome")
    };
    this.firefox = function() {
        return this.check("firefox")
    };
    this.netscape = function() {
    ...
    this.gecko = function() {
        return this.check("gecko")
    };
    this.khtml = function() {
        return this.check("khtml")
    };
    this.windows = function() {
        return this.check("windows")
    };
    this.windows2000 = function() {
        return this.check("windows nt 5.0")
    };
    this.windowsXP = function() {
        return this.check("windows nt 5.1")
    };
    this.windows98 = function() {
        return this.check("windows 98")
    };
    this.mac = function() {
        return this.check("mac")
    };
    this.linux = function() {
...
var NgbAjax = new function __NgbAjax() {
    ...
    this.AddRequest = function(objAjaxRequest) {
        ...
        if (this.NxRequest[nIndex]) {
            ...
            this.NxRequest[nIndex].onreadystatechange = function() {
                objAjaxRequest.HandleReponse(nIndex);
            };
    ...
    this.AddAmlRequest = function(objAjaxRequest) {
        ...
        if (this.NxRequest[nIndex]) {
            ...
            this.NxRequest[nIndex].setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=ks_c_5601-1987');
            this.NxRequest[nIndex].onreadystatechange = function() {
                objAjaxRequest.HandleAmlReponse(nIndex);
            };
            this.NxRequest[nIndex].send(objAjaxRequest.GetPostData());
        }
    }
...
function __NgbAjaxRequest(url) {
    ...
    this.AddQueryString = function(key, value) {
        this.arrQueryString[this.arrQueryString.length] = {
            key: key,
            value: value
        };
    }
    ...
    this.AddPostData = function(key, value) {
        this.arrPostData[this.arrPostData.length] = {
            key: key,
            value: value
        };
    }
...
function __NgbUserEvent() {
    this.MousePositionX = function(evnt) {
        ...
        if (window.pageYOffset) {
            LeftValue = window.pageXOffset;
        } else if (document.documentElement && document.documentElement.scrollTop) {
            LeftValue = document.documentElement.scrollLeft;
        } else if (document.body) {
            LeftValue = document.body.scrollLeft;
        }

        if (NgbBrowser.msie()) {
            return LeftValue + event.clientX;
        } else {
            return evnt.pageX;
        }
    };
        ...
        if (typeof(delay) == 'undefined') {
            ...
            if (document.getElementById(objID))
                ...
                window.setTimeout(function() {
                    NgbDisplay.AppendHTML(objID, html, delay)
                }, delay);
        }
    }
}
...
var NgbChanneling = new function __NgbChanneling() {
    this.OpenCashChargeList = function(n1ChannelingCode) {
        ...
        switch (n1ChannelingCode) {
            case 1:
                strDomainURL = 'http://nexon.game.daum.net';
                break;
